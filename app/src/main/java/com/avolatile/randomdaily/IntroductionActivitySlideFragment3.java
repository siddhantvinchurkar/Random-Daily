 ...
 */
public class IntroductionActivitySlideFragment3 extends Fragment implements ISlideBackgroundColorHolder{
    ...
    public IntroductionActivitySlideFragment3() {
    ...
    public static IntroductionActivitySlideFragment3 newInstance(String param1, String param2) {
        IntroductionActivitySlideFragment3 fragment = new IntroductionActivitySlideFragment3();
